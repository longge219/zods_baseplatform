...
package com.zods.largescreen.modules.accessuser.service.impl;
...
import com.zods.largescreen.modules.accessrole.dao.AccessRoleAuthorityMapper;
import com.zods.largescreen.modules.accessrole.dao.AccessRoleMapper;
import com.zods.largescreen.modules.accessrole.dao.entity.AccessRole;
import com.zods.largescreen.modules.accessrole.dao.entity.AccessRoleAuthority;
...
import com.zods.largescreen.modules.accessuser.dao.AccessUserMapper;
import com.zods.largescreen.modules.accessuser.dao.AccessUserRoleMapper;
import com.zods.largescreen.modules.accessuser.dao.entity.AccessUser;
import com.zods.largescreen.modules.accessuser.dao.entity.AccessUserRole;
...
public class AccessUserServiceImpl implements AccessUserService {
    ...
    public GaeaUserDto login(GaeaUserDto gaeaUserDto) {
        ...
        if (redisCacheHelper.exist(tokenKey)) {
            token = redisCacheHelper.stringGet(tokenKey);
        } else {
            // 生成用户token
...
//        List<String> authorities = accessUserMapper.queryAuthoritiesByLoginName(loginName);
        ...
        redisCacheHelper.stringSetExpire(userKey, gaeaUserStr, 3600);
