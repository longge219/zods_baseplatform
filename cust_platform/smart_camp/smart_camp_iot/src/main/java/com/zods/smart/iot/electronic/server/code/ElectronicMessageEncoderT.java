 ...
 * @create 2022-06-11
 **/
public class ElectronicMessageEncoderT {

	public static void doEncode(ChannelHandlerContext ctx, DatagramPacket datagramPacket,ElectronicPacketHead packetHead) throws Exception {
		...
		/**===========验证码end===============*/
		//发送数据
		ctx.writeAndFlush(new DatagramPacket(out, datagramPacket.sender()));
	}
	...
	private static void fileldEncode( ByteBuf out, String type, String length, Object value) throws Exception {
