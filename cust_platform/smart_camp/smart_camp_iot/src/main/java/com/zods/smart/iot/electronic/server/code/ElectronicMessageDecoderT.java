 ...
 **/
@Slf4j
public class ElectronicMessageDecoderT{

	/**报文最小长度*/
	private static Integer packetHeadSize = 8;

	public static  ElectronicPacketHead doDecode(ByteBuf inByteBuf) throws Exception {
		/**消息体长度判断*/
	...
	private static Object getObjectByBuffer(Class<?> clazz, ByteBuf inByteBuf,int msgLength) throws Exception {
		// 实例化类
	 ...
	 * @throws Exception
	 */
	private static Object getValues(String type, String len, String mark,int msgLength,ByteBuf ioBuffer) throws Exception {
		//数组长度
