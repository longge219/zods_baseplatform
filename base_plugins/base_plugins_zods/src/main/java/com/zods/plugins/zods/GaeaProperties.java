...
public class GaeaProperties {
    ...
    private GaeaProperties.Security security = new GaeaProperties.Security();
    ...
    public GaeaProperties.Security getSecurity() {
        return this.security;
    }

    public void setSecurity(GaeaProperties.Security security) {
