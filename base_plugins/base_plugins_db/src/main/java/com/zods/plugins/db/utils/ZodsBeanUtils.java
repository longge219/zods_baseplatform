...
import com.zods.plugins.db.annotation.DtoSkip;
import com.zods.plugins.db.annotation.Formatter;
import com.zods.plugins.db.annotation.FormatterType;
import com.zods.plugins.db.cache.CacheHelper;
import com.zods.plugins.db.constant.Enabled;
 ...
 */
public abstract class ZodsBeanUtils {
    private static final Logger logger = LoggerFactory.getLogger(ZodsBeanUtils.class);

    public ZodsBeanUtils() {
    }
    ...
    public static <T> T copyAndFormatter(Object source, T target) {
        ...
        org.springframework.beans.BeanUtils.copyProperties(source, target, (String[])skipFields.toArray(new String[0]));
